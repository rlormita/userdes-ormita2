<?php header( 'Location: /certificates.html' ) ;  ?>
<html>
<head>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
	...
	<h1 class="masthead-heading text-uppercase mb-0">CERTIFICATES</h1>
	<br>
	<br>
	...
	<!-- Icon Divider -->
		...
		<p align="center">	<a class="nav-link text-uppercase text-expanded" href="https://www.linkedin.com/in/rommel-o-29a6ba111/">LinkedIn Profile</a></p>
	<!-- Masthead Subheading -->
